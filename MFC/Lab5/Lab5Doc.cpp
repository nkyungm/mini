...
// 축소판 그림을 지원합니다.
void CLab5Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CLab5Doc::InitializeSearchContent()
{
...
void CLab5Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
